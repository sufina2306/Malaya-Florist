...
<body>
            ...
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav  ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route ('auth.register') }}">Produk</a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="detail-box">
                                            <h1>
                                                Selamat Datang di <br> Malaya Florist
                                            </h1>
                                            <p>
    ...
    <section class="shop_section layout_padding">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                    Temukan beragam desain terbaik
                </h2>
            </div>
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="{{route('auth.register')}}">
                            <span class="p-4"></span>
                            <div class="img-box">
                                <img src="{{ asset('image/A(1).jpeg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    AB-001
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="{{route('auth.register')}}">
                            <span class="p-4"></span>
                            <div class="img-box">
                                <img src="{{ asset('image/A(2).jpeg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    AB-001
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="{{route('auth.register')}}">
                            <span class="p-4"></span>
                            <div class="img-box">
                                <img src="{{ asset('image/A(3).jpeg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    AB-001
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="box">
                        <a href="{{route('auth.register')}}">
                            <span class="p-4"></span>
                            <div class="img-box">
                                <img src="{{ asset('image/A(6).jpg') }}" alt="">
                            </div>
                            <div class="detail-box">
                                <h6>
                                    AB-001
            ...
            <div class="btn-box">
                <a href="{{ route('auth.register') }}" id="showModalBtn">
                    Lihat Semua Produk
                </a>
            </div>
        </div>
    ...
    <div class="modal" id="myModal">
        <div class="modal-content">
            ...
            <h2>Pilih Login atau Register</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="detail-box">
                            ...
                            <div class="btn-box">
                                <a href="{{ route('auth.register') }}" class="btn1">
                                    Pesan Sekarang
                                </a>
                            </div>
                        </div>
    ...
    <sc ript src="{{ asset('assets/js/jquery-3.4.1.min.js') }}">
        </script>
