                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('postTambahProduk') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="kodeproduk" class="form-control" required id="kodeproduk">
                                                    <span class="text-danger">
                                                        @error('kodeProduk'){{ $message }}@enderror</span>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="kategori" id="kategori" required>
                                                        <option value="">--Pilih Ucapan--</option>
                                                        <option value="congratulations">Ucapan Selamat</option>
                                                        <option value="pernikahan">Ucapan Pernikahan</option>
                                                        <option value="duka_cita">Uapan Duka Cita</option>
