...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assetsadmin/vendors/select2-bootstrap-theme/select2-bootstrap.min.css') }}" />
    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('image/logo.png') }}" width="100px" height="50px" alt="logo" /> </a>
                <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="{{ asset('image/logo.png') }}" width="200px" height="50px" alt="logo" /></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
                    <a class="navbar-brand brand-logo-mini align-self-center d-lg-none" href="index.html"><img src="{{ asset('image/logo.png') }}" width="50px" height="auto" alt="logo" /></a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="{{ route('postTambahAdmin') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="mb-3">
                                                    <label for="password" class="form-label text-black"><span style="font-size: 13px;">Kata sandi</span></label>
                                                    <input type="password" name="password" class="form-control" required id="formGroupExampleInput">
                                                    <span class="text-danger">
                                                        @error('password')
                                                        {{ $message }}
                                                        @enderror
                                                ...
                                                <div class="mb-3">
                                                    <label for="password" class="form-label text-black"><span style="font-size: 13px;">Konfirmasi Kata
                                                            sandi</span></label>
                                                    <input type="password" name="password_confirmation" class="form-control" required id="formGroupExampleInput">
                                                    <span class="text-danger">
