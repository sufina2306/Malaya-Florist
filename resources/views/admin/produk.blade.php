...
<body>
                ...
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="{{route('admin.tambahProduk')}}"><button type="button"
                        ...
                        <div class="col-md-6 mb-3">
                            <form action="{{ route('admin.produk') }}" method="GET">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Cari berdasarkan kode produk" name="search">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a type="button" class=" " data-toggle="modal"
                                                        data-target="#deskripsiModal{{ $produk->id }}">
                                                        Lihat Deskripsi
                                                    </a>
                                                    <!-- Modal deskripsi-->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <!-- modal-lg class untuk modal yang lebih besar -->
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                <!-- max-height dan overflow-y akan memberikan batas tinggi dan memunculkan scrollbar jika diperlukan -->
                {{ $produk->deskripsi }}
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                                ...
                                                <td> <img style="width: 50px; cursor: pointer;"
                                                        ...
                                                        alt="cover produk" data-toggle="modal"
                                                        data-target="#gambarModal{{ $produk->id }}">
                                                </td>
                                                <td>
                                                    <a class="btn btn-outline-warning"
                                                        href="/admin/editProduk/{{ $produk->id }}">Edit</a>
                                                    <a class="btn btn-outline-danger"
                                                        href="/admin/deleteProduk/{{ $produk->id }}">Delete</a>
                                                </td>
                                                <div class="modal fade" id="gambarModal{{ $produk->id }}" tabindex="-1"
