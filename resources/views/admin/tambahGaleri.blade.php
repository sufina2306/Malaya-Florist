    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('image/logo.png') }}"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="{{ route('postGaleri') }}" method="POST"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="text-danger">
                                                        @error('judul'){{ $message }}@enderror</span>
                                                </div>
                                                <div class="form-group">
